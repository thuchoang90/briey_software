...
80000068:	2a8080e7          	jalr	680(ra) # 4000030c <irqCallback>
  lw x1 , 15*4(sp)
...
800000b8:	b8418193          	addi	gp,gp,-1148 # 40000c38 <__global_pointer$>
  .option pop
  la sp, _stack_start
...
800000c8:	37450513          	addi	a0,a0,884 # 40000438 <_ctors_end>
  la a1, _bss_end
800000cc:	c0000597          	auipc	a1,0xc0000
800000d0:	36c58593          	addi	a1,a1,876 # 40000438 <_ctors_end>
...
800000e8:	35450513          	addi	a0,a0,852 # 40000438 <_ctors_end>
  addi sp,sp,-4
...
800000f4:	34858593          	addi	a1,a1,840 # 40000438 <_ctors_end>
...
int main() {
4000028c:	fe010113          	addi	sp,sp,-32
40000290:	00112e23          	sw	ra,28(sp)
40000294:	00812c23          	sw	s0,24(sp)
40000298:	02010413          	addi	s0,sp,32
	Uart_Config uartConfig;
	uartConfig.dataLength = 8;
4000029c:	00800793          	li	a5,8
400002a0:	fef42023          	sw	a5,-32(s0)
	uartConfig.parity = NONE;
400002a4:	fe042223          	sw	zero,-28(s0)
	uartConfig.stop = ONE;
400002a8:	fe042423          	sw	zero,-24(s0)
	uartConfig.clockDivider = (CORE_HZ / 8 / 115200) - 1;
400002ac:	03500793          	li	a5,53
400002b0:	fef42623          	sw	a5,-20(s0)
	uart_applyConfig(UART,&uartConfig);
400002b4:	fe040793          	addi	a5,s0,-32
...
400002c8:	38878513          	addi	a0,a5,904 # 40000388 <vga_simRes_h160_v120+0x20>
400002cc:	f6dff0ef          	jal	ra,40000238 <print>
	print("University of Electro-Communications (UEC), Tokyo, Japan\r\n");
400002d0:	400007b7          	lui	a5,0x40000
400002d4:	3b478513          	addi	a0,a5,948 # 400003b4 <vga_simRes_h160_v120+0x4c>
400002d8:	f61ff0ef          	jal	ra,40000238 <print>
	print("電気通信大学、東京都、日本\r\n");
400002dc:	400007b7          	lui	a5,0x40000
400002e0:	3f078513          	addi	a0,a5,1008 # 400003f0 <vga_simRes_h160_v120+0x88>
400002e4:	f55ff0ef          	jal	ra,40000238 <print>
	print("PHAM LAB ! 範研究室 !\r\n");
400002e8:	400007b7          	lui	a5,0x40000
400002ec:	41c78513          	addi	a0,a5,1052 # 4000041c <vga_simRes_h160_v120+0xb4>
400002f0:	f49ff0ef          	jal	ra,40000238 <print>
400002f4:	00000793          	li	a5,0
}
400002f8:	00078513          	mv	a0,a5
400002fc:	01c12083          	lw	ra,28(sp)
40000300:	01812403          	lw	s0,24(sp)
40000304:	02010113          	addi	sp,sp,32
40000308:	00008067          	ret

4000030c <irqCallback>:


void irqCallback(){
4000030c:	ff010113          	addi	sp,sp,-16
40000310:	00812623          	sw	s0,12(sp)
40000314:	01010413          	addi	s0,sp,16

}
40000318:	00000013          	nop
4000031c:	00c12403          	lw	s0,12(sp)
40000320:	01010113          	addi	sp,sp,16
