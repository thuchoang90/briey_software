...
//////////// uncomment this function if you want to print all intermediate state ////////////
//void uart_state(Uart_Reg *reg, state_t* state) {
//	int num_nibbles = sizeof((*state)[0][0]) * 2;
//	uint8_t i,j;
//	  for (i = 0; i < 4; ++i)
//	  {
//	    for (j = 0; j < 4; ++j)
...
//	    	    char nibble = (((*state)[i][j]) >> (nibble_idx * 4)) & 0xf;
